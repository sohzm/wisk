class Heading5Element extends BaseTextElement {
    constructor() {
        super();
    ...
    render() {
        ...
        `;
        const content = `
            <h5 id="editable" contenteditable="${!wisk.editor.readonly}" spellcheck="false" data-placeholder="${this.placeholder}"></h5>
...
customElements.define('heading5-element', Heading5Element);
